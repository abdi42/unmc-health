...
class ContentsController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    $questions->map(function ($newQuestion) use ($content) {
      ...
      $options->map(function ($option, $key) use ($correctAnswer, $question) {
        $answer = new Answer();
    ...
    return redirect('/contents/' . $content->id)->with('status', 'Added new content!');
  }
  ...
  public function update(Request $request, $id)
  {
    ...
    $questions->map(function ($questionData) use ($content) {
      ...
      $options->map(function ($optionData, $key) use ($questionData, $question) {
